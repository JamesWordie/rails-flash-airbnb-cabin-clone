...
price_per_night: 50.upto(100).to_a.sample,
number_of_guests: 2.upto(8).to_a.sample,
location: "Cranleigh, Surrey, South England"
)
...
price_per_night: 50.upto(100).to_a.sample,
number_of_guests: 2.upto(8).to_a.sample,
location: "Lake District, North England"
)
...
price_per_night: 50.upto(100).to_a.sample,
number_of_guests: 2.upto(8).to_a.sample,
location: "Bury St Edmunds, Suffolk, East England"
)
...
price_per_night: 50.upto(100).to_a.sample,
number_of_guests: 2.upto(8).to_a.sample,
location: "Hemingford Grey, Cambridgeshire, East England"
)
...
price_per_night: 50.upto(100).to_a.sample,
number_of_guests: 2.upto(8).to_a.sample,
location: "Tarporley, Cheshire, North West England"
)
